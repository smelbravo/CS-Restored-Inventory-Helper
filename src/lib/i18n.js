...
(function (global) {
    ...
    const enUS = {
        ...
        'feature.sellHubPage.label': 'Sell Hub (standalone page)',
        'feature.sellHubPage.desc': 'Lightweight sell & list page — less lag on huge inventories',
        ...
        'qs.batchHint': 'When the site or API is slow, keep batch size low (2 is safest). Higher batches may fail to sell some skins.',
        ...
        'cases.tab.stats': 'Stats',
        'cases.stats.lead': 'Lifetime case opens tracked on csrestored.fun (site + extension auto-open).',
        'cases.stats.sinceGold': 'Cases since last gold',
        'cases.stats.sinceGoldHint': '★ knives & gloves reset this counter',
        'cases.stats.totalOpened': 'Total opened',
        'cases.stats.totalGold': 'Total gold',
        'cases.stats.lastGold': 'Last gold',
        'cases.stats.lastOpen': 'Last drop',
        'cases.stats.never': 'Never',
        'cases.stats.recentGold': 'Recent gold drops',
        'cases.stats.recentGoldLine': '{name} · after {opens} cases',
        'cases.stats.noGoldYet': 'No gold yet — keep opening!',
        'cases.stats.reset': 'Reset stats',
        'cases.stats.resetConfirm': 'Reset all case opening stats? This cannot be undone.',
        'cases.stats.resetDone': 'Case stats reset.',
        'cases.stats.showMore': 'See more',
        'cases.stats.showLess': 'See less',
        'cases.stats.rarityTitle': 'Drops by rarity',
        'cases.stats.rarityGold': '★ Gold (knives & gloves)',
        'sellHub.title': 'Sell Hub',
        'sellHub.subtitle': 'Lightweight sell & list — your inventory only',
        'sellHub.subtitleUser': 'Account {id}',
        'sellHub.fabTitle': 'Open Sell Hub — sell outside the site UI (less lag)',
        'sellHub.loading': 'Loading inventory…',
        'sellHub.loadError': 'Could not load inventory: {msg}. Log in on csrestored.fun and try again.',
        'sellHub.confirming': 'Confirming sales with server…',
        'sellHub.confirmingProgress': 'Confirming {gone}/{all} sold…',
        'sellHub.apiChecking': 'API…',
        'sellHub.apiOk': 'API {ms}ms',
        'sellHub.apiSlow': 'API slow · {ms}ms',
        'sellHub.apiOffline': 'API unreachable',
        'sellHub.noItems': 'No items in your inventory.',
        'sellHub.noResults': 'No items match your filters.',
        'sellHub.searchPlaceholder': 'Search weapon or skin…',
        'sellHub.refresh': 'Refresh',
        'sellHub.openSite': 'Open inventory on site ↗',
        'sellHub.stats': '{total} items · showing {showing} · {selected} selected',
        'sellHub.selectAll': 'Select all (filtered)',
        'sellHub.clearSelection': 'Clear',
        'sellHub.sellByRarity': 'Select rarity…',
        'sellHub.batchSize': 'Batch',
        'sellHub.review': 'Review & sell',
        'sellHub.reviewN': 'Review & sell ({n})',
        'sellHub.allRarities': 'All rarities',
        'sellHub.sortRarity': 'Rarity',
        'sellHub.sortFloat': 'Float',
        'sellHub.sortRecent': 'Last dropped',
        'sellHub.sortName': 'Name',
        'sellHub.sortDirDesc': '{label} — high to low (click to reverse)',
        'sellHub.sortDirAsc': '{label} — low to high (click to reverse)',
        'sellHub.recentDropBadge': 'New drop',
        'sellHub.locked': 'Locked',
        'sellHub.loadMore': 'Load more…',
        'sellHub.rarityPrompt': 'Rarity number (1–7) to select all visible items of that tier:',
        'sellHub.confirmQuickSell': 'Quick sell {n} selected items? This cannot be undone.',
        'sellHub.confirmList': 'List {n} items on the marketplace at the prices entered?',
        'sellHub.lockDisabled': 'Enable Skin lock in extension settings to use locks here.',
        'sellHub.yourCoins': 'Your coins',
        'sellHub.footerMarketTotal': 'Marketplace total: {total}',
        'sellHub.cardMarketValue': 'Market value: {total}',
        ...
        'cases.minutesMaxHint': 'Max {max} min',
        ...
        'cases.log.errorRetry': 'Error: {msg} — retrying ({n}/{max})…',
        'cases.log.errorStop': 'Stopped after {n} consecutive errors — last: {msg}',
